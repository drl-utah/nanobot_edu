...
for a = 1:gestureCount %iterate through all gestures
    for b = 1:trialCount %iterate through all trials
        ...
        Features(a,b,:) = mean(singleLetter,2); % YOU CAN MODIFY THIS LINE
...
maxEpoch = 1000; %how long the network learns
...
xTestLive(:,:,:,1) = mean(singleLetter,2); % YOU CAN MODIFY THIS LINE 
