...
pause(0.03);
while (toc < 10)  % Adjust me if you want to stop your line following earlier, or let it run longer.
    ...
    error = -4*vals.one - 2*vals.two - 1*vals.three + 1*vals.four + 2*vals.five + 4*vals.six;
